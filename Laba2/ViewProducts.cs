    ...
    public partial class ViewProducts : Form
    {
        ...
        public ViewProducts(string operationToDo)
        {
            ...
            if (operationToDo == "ADD")
            {
                ...
                EnableOrDisable.EnableAndVisible(true, true, label1, label2, label3, label4, comboBox1,
                    comboBox2, comboBox3, comboBox4, button1);
            ...
            if (operationToDo == "DELETE")
            {
                ...
                EnableOrDisable.EnableAndVisible(false, false, label1, label2, label3, label4, comboBox1,
                    comboBox2, comboBox3, comboBox4, dataGridView1);
                button1.Location = new System.Drawing.Point(156, 99);
                button1.Text = "Delete product";
            }
            if (operationToDo == "VIEW")
            {
                EnableOrDisable.EnableAndVisible(true, true, dataGridView1);
                EnableOrDisable.EnableAndVisible(false, false, label1, label2, label3, label4, label5,
                    comboBox1, comboBox2, comboBox3, comboBox4, comboBox5, button1);
                    ...
                    IsComboBoxEmpty(comboBox4, "Please write type of product"))
                {
                    ...
                    else
                    {
                        Products.ProductsListBase.Add(new Products(comboBox1.Text, int.Parse(comboBox2.Text),
                                                double.Parse(comboBox3.Text), comboBox4.Text));
